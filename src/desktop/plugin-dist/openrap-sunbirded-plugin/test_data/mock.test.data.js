...
exports.location_state_empty = {
    result: {
        response: []
    }
};
exports.location_district = {
    result: {
        response: [
            {
                "code": "2907",
...
exports.location_district_empty = {
    result: {
        response: []
    }
};
exports.appUpdate = {
    termsOfUseUrl: `${routes_spec_data_1.env.APP_BASE_URL}/term-of-use.html`,
    deviceId: '687476',
...
exports.get_content_error = { id: 'api.content.read',
    ver: '1.0',
    ts: '2020-03-06T13:14:16.174Z',
    params: { resmsgid: 'a8e8b2b5-fe29-4322-afa6-a6fde3bd89f2',
