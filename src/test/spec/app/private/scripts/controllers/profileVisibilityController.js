...
describe('Controller: profileVisibilityController', function () {
    beforeEach(module('playerApp'));
    var profVisCtrl,
        scope,
        rootScope,
    ...
    beforeEach(inject(function (
        ...
        profVisCtrl = $controller('profileVisibilityController', {
            $scope: scope,
            rootScope: rootScope,
...
it('should change field visibility ', function (done) {
    rootScope.privateProfileFields = ['dob']
    scope.field = 'dob';
    spyOn(profVisCtrl, 'setProfileFieldLbl').and.callThrough();
    profileCtrl.setProfileFieldLbl();
    scope.$apply();
    expect(profVisCtrl.updateProfVisFields).not.toHaveBeenCalled();
    done();
});
