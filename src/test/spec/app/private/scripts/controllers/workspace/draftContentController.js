...
describe('Controller:DraftContentController', function(){
    ...
    var contentService,
        ...
        errorMessage,
        createContoller,
        draftcontentSuccess = {id:'api.v1.search',ver:'1.0',ts:'2017-09-22T11:42:07.455Z',
        params:{resmsgid:'0fecfef0-9f8b-11e7-b050-d9109721da9d',
        msgid:'0fe73290-9f8b-11e7-9161-9b28d749346d',status:'successful',err:null,errmsg:null},
        responseCode:'OK',
        result:{count:25,content:[{code:'org.sunbird.17n6Ve',channel:'505c7c48ac6dc1edc9b08f21db5a571d',language:['English'],mimeType:'application/vnd.ekstep.content-collection',idealScreenSize:'normal',createdOn:'2017-09-22T09:13:18.709+0000',objectType:'Content',appId:'sunbird_portal',contentDisposition:'inline',lastUpdatedOn:'2017-09-22T09:13:18.709+0000',contentEncoding:'gzip',contentType:'Collection',identifier:'do_212337738536624128187',createdFor:['ORG_001'],creator:'AmitKumar',audience:['Learner'],
        IL_SYS_NODE_TYPE:'DATA_NODE',visibility:'Default',os:['All'],consumerId:'fa271a76-c15a-4aa1-adff-31dd04682a1f',
        mediaType:'content',osId:'org.ekstep.quiz.app',graph_id:'domain',nodeType:'DATA_NODE',versionKey:'1506071598709',
        idealScreenDensity:'hdpi',createdBy:'be7efb23-6af9-4d92-82b3-a4d78fcfa2f6',compatibilityLevel:1,
        IL_FUNC_OBJECT_TYPE:'Content',name:'Untitled collection',IL_UNIQUE_ID:'do_212337738536624128187',
        status:'Draft',node_id:73573,es_metadata_id:'do_212337738536624128187'},
