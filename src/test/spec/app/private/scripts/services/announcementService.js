...
describe('Service: announcementService', function() {
    ...
    describe('Test announcement service', function() {
        ...
        it('Define delete announcement', function() {
        ...
        it('Define resend announcement', function() {
        ...
        it('Resend announcement', function() {
            ...
            var requestBody = {
                'request': {
                    ...
                    'createdBy': 'd56a1766-e138-45e9-bed2-a0db5eb9696a',
                    'type': 'Circular',
                    'links': ['http://yahoo.com', 'http://google.com', 'http://gmail.com'],
                    'title': 'Test title for announcement 001',
                    'description': 'Test description for announcement 001',
                    'target': {
                        'geo': {
