var announcementTestData = {
  getAnnouncementInbox: {
    successResponce: {'id': 'api.plugin.announcement.user.inbox', 'ver': '1.0', 'ts': '2017-11-16 04:59:39:461+0000', 'params': {'resmsgid': 'f351c750-ca8a-11e7-b553-0ffa8051c99e', 'msgid': null, 'status': 'successful', 'err': '', 'errmsg': ''}, 'responseCode': 'OK', 'result': {'count': 215, 'announcements': [{'sourceid': '0123673908687093760', 'createddate': '2017-11-13 04:32:05:885+0000', 'details': {'description': 'Test description for announcement 90', 'from': 'test user', 'title': 'Test title for announcement 9011111111111111111', 'type': 'Circular'}, 'links': ['http://yahoo.com'], 'id': '9a78dad0-c82b-11e7-8175-573a15bbe3f0', 'userid': 'd56a1766-e138-45e9-bed2-a0db5eb9696a', 'target': {'geo': {'ids': ['0123668627050987529']}}, 'status': 'active', 'read': false, 'received': false}]}},
    ...
    detailsSuccess: {'sourceid': '0123673908687093760', 'createddate': '2017-11-13 04:32:05:885+0000', 'details': {'description': 'Test description for announcement 90', 'from': 'test user', 'title': 'Test title for announcement 9011111111111111111', 'type': 'Circular'}, 'links': ['http://yahoo.com'], 'id': '9a78dad0-c82b-11e7-8175-573a15bbe3f0', 'userid': 'd56a1766-e138-45e9-bed2-a0db5eb9696a', 'target': {'geo': {'ids': ['0123668627050987529']}}, 'status': 'active', 'read': false, 'received': false},
    receivedSucess: {'id': 'api.plugin.announcement.received', 'ver': '1.0', 'ts': '2017-11-16 05:19:03:806+0000', 'params': {'resmsgid': 'a952b9e0-ca8d-11e7-8b5d-b7dcc410578e', 'msgid': null, 'status': 'successful', 'err': '', 'errmsg': ''}, 'responseCode': 'OK', 'result': {'metrics': {'id': 'a93e6e90-ca8d-11e7-8b5d-b7dcc410578e'}}}
  },
