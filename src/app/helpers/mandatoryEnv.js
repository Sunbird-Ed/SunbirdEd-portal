...
// Fallback Token for Mandatory  variables
const token = '';
...
let mandEnvVariables = {
    ...
    sunbird_anonymous_register_token: env.sunbird_anonymous_register_token || token,
    // Fallback token for device register API for `anonymous` users
    sunbird_anonymous_default_token: env.sunbird_anonymous_default_token || token,
    ...
    sunbird_cloud_storage_provider: env.sunbird_cloud_storage_provider || '',
}
