...
//   sunbird_data_product_service: env.sunbird_data_product_service || 'https://staging.open-sunbird.org/api/data/v1/report-service',
...
//   },
//   CONTENT_EDITORS_URL: {
//     COLLECTION_EDITOR: env.sunbird_collectionEditorURL || 'COLLECTION_EDITOR__https://staging.open-sunbird.org/api/data/v1/report-service',
//     CONTENT_EDITOR: env.sunbird_contentEditorURL || 'CONTENT_EDITOR__https://staging.open-sunbird.org/api/data/v1/report-service',
//     GENERIC_EDITOR: env.sunbird_genericEditorURL || 'GENERIC_EDITOR__https://staging.open-sunbird.org/api/data/v1/report-service'
//   },
//   // PhraseApp configuration
//   PHRASE_APP: {
//     phrase_authToken: env.sunbird_phraseApp_token || 'AU',
//     phrase_project: env.phrase_project || 'DIKSHA Portal',
//     phrase_locale: env.phrase_locale || ['en-IN', 'bn-IN', 'hi-IN', 'kn-IN', 'mr-IN', 'ur-IN', 'te-IN', 'ta-IN'],
//     phrase_fileformat: env.phrase_fileformat || 'nested_json'
//   },
