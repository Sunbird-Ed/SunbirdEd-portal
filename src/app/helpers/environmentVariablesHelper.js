...
let envVariables = {
  LEARNER_URL:
    env.sunbird_learner_player_url || "https://dev.sunbirded.org/api/",
  CONTENT_URL:
    env.sunbird_content_player_url || "https://dev.sunbirded.org/api/",
  CONFIG_URL:
    env.sunbird_config_service_url || "https://dev.sunbirded.org/api/config/",
  CONFIG_REFRESH_INTERVAL: env.config_refresh_interval || 10,
  CONFIG_SERVICE_ENABLED: env.config_service_enabled || false,
  CONTENT_PROXY_URL:
    env.sunbird_content_proxy_url || "https://dev.sunbirded.org",
  PORTAL_REALM: env.sunbird_portal_realm || "sunbird",
  PORTAL_AUTH_SERVER_URL:
    env.sunbird_portal_auth_server_url || "https://dev.sunbirded.org/auth",
  ...
  PORTAL_API_AUTH_TOKEN:
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiIyZThlNmU5MjA4YjI0MjJmOWFlM2EzNjdiODVmNWQzNiJ9.gvpNN7zEl28ZVaxXWgFmCL6n65UJfXZikUWOKSE8vJ8",
  PORTAL_TELEMETRY_PACKET_SIZE: env.sunbird_telemetry_packet_size || 1000,
  PORTAL_ECHO_API_URL:
    env.sunbird_echo_api_url || "https://dev.sunbirded.org/api/echo/",
  ...
  DATASERVICE_URL:
    env.sunbird_dataservice_url || "https://dev.sunbirded.org/api/",
  ...
  BUILD_NUMBER:
    env.sunbird_build_number || packageObj.version + "." + packageObj.buildHash,
  ...
  GOOGLE_OAUTH_CONFIG: {
    clientId:
      env.sunbird_google_oauth_clientId ||
      "671624305038-e8pbpmidst6lf0j5qplp6g6odan3lbf5.apps.googleusercontent.com" ||
      "903729999899-7vcrph3vro36ot43j1od8u6he9jjend0.apps.googleusercontent.com",
    clientSecret:
      env.sunbird_google_oauth_clientSecret ||
      "mDO2MM68iW23f47ZFtvREld9" ||
      "BAEAYRv7voTByz5rOKkbIE3u",
  },
  KEYCLOAK_GOOGLE_CLIENT: {
    clientId: env.sunbird_google_keycloak_client_id || "google-auth",
    secret:
      env.sunbird_google_keycloak_secret ||
      "8486df4b-2ec0-4249-92d8-5f3a7064cd07",
  },
  sunbird_google_captcha_site_key:
    env.sunbird_google_captcha_site_key ||
    "6Ldcf4EUAAAAAMrKQSviNtEzMretoDgeAUxqJv7d",
  ...
  sunbird_azure_account_key:
    env.sunbird_azure_account_key ||
    "hVZeCECRUwsIZEL2h+GqF3bRo5Iz365G+zhrOZlYYYXBmrjuv4NyBv47xsmcvyQvAQPnnLG9r9iGil9TLgeyeA==",
  ...
  sunbird_portal_offline_app_download_url:
    ...
    "https://sunbird-ed.github.io/sunbird-style-guide/dist/#/test-page",
