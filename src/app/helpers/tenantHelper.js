    ...
    if (tenantId) {
      async.parallel({
        ...
        responseObj.logo = baseUrl + (results.logo
          ? '/tenant/' + tenantId + '/logo.png' : '/assets/images/sunbird_logo.png')
        responseObj.poster = baseUrl + (results.poster
          ? '/tenant/' + tenantId + '/poster.png' : '/assets/images/sunbird_logo.png')
        responseObj.favicon = baseUrl + (results.favicon
          ? '/tenant/' + tenantId + '/favicon.ico' : '/assets/images/favicon.ico')
