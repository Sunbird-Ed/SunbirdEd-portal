...
const replicationStrategy = cassandraUtils.getReplicationStrategy(
  envHelper.PORTAL_CASSANDRA_REPLICATION_STRATEGY
);
const consistency = cassandraUtils.getConsistencyLevel(
  envHelper.PORTAL_CASSANDRA_CONSISTENCY_LEVEL
);
