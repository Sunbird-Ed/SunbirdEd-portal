...
var cdnurl = (argv.cdnurl || envHelper.TENANT_CDN_URL || 'https://dev-sunbird-temp.azureedge.net') + '/' + containerName;
...
gulp.task('upload-app-to-cdn', function () {
  console.log("cdnServiceCredentials",cdnServiceCredentials)
