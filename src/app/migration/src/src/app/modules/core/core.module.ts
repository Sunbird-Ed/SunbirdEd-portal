...
import {
  ...
  BadgesService, ContentService, CoursesService, PageSectionService
} from './services';
import {
...
@NgModule({
  ...
  providers: [
    ...
    PermissionService, AnnouncementService, BadgesService, ContentService, CoursesService, PageSectionService ]
})
