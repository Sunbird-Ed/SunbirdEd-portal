...
describe('OutboxComponent', () => {
    ...
    it('should call outbox api and get error response', inject([AnnouncementService, ToasterService, ResourceService,
        ...
        (announcementService, toasterService, resourceService, http, configService) => {
            ...
            component.populateOutboxData(configService.pageConfig.ANNOUNCEMENT.OUTBOX.PAGE_LIMIT, component.pageNumber);
            ...
            expect(component.pageLimit).toBe(configService.pageConfig.ANNOUNCEMENT.OUTBOX.PAGE_LIMIT);
        }));
    ...
    it('should call setpage method and set proper page number', inject([ConfigService, Router],
        (configService, route) => {
            ...
            expect(component.pageLimit).toEqual(configService.pageConfig.ANNOUNCEMENT.OUTBOX.PAGE_LIMIT);
