...
describe('InboxComponent', () => {
    ...
    it('should call inbox api and get error response', inject([AnnouncementService, ToasterService, ResourceService,
        ...
        (announcementService, toasterService, resourceService, http, configService) => {
            ...
            component.populateInboxData(configService.pageConfig.ANNOUNCEMENT.INBOX.PAGE_LIMIT, component.pageNumber);
            ...
            expect(component.pageLimit).toBe(configService.pageConfig.ANNOUNCEMENT.INBOX.PAGE_LIMIT);
        }));
    ...
    it('should call setpage method and set proper page number', inject([ConfigService, Router],
        (configService, route) => {
            ...
            expect(component.pageLimit).toEqual(configService.pageConfig.ANNOUNCEMENT.INBOX.PAGE_LIMIT);
