...
module.exports = (app, keycloak) => {
  ...
  '/resources/*', '/myActivity', '/myActivity/*', '/org/*', '/manage', '/contribute','/contribute/*','/groups','/groups/*', '/my-groups','/my-groups/*'], 
  session({
...
function getLocals(req) {
  ...
  locals.p1reCaptchaEnabled = envHelper.sunbird_p1_reCaptcha_enabled.toString();
  locals.p2reCaptchaEnabled = envHelper.sunbird_p2_reCaptcha_enabled.toString();
  locals.p3reCaptchaEnabled = envHelper.sunbird_p3_reCaptcha_enabled.toString();
  return locals
}
