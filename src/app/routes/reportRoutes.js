...
try {
    ...
    console.warn('[reportRoutes] Cloud storage is not configured. Cloud features will be unavailable.');
}
  ...
  app.all(['/report/v1/collection/summary'],
    ...
    app.get('/courseReports/:slug/:filename',
        ...
        StorageService.CLOUD_CLIENT
            ...
            : (req, res) => res.status(503).json({ message: 'Cloud storage not configured' }));
