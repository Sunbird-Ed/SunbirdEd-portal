...
export class LoadContentComponent implements OnInit {
  ...
  msgToShow() {
    this.isConnected ? (this.onlineMsg = this.resourceService.frmelmnts.lbl.online, this.selectedValue = 'browse') :
      (this.onlineMsg = this.resourceService.frmelmnts.lbl.offline, this.selectedValue = 'import');
