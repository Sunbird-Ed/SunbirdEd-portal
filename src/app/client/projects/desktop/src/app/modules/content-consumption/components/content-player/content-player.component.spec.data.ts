export const playerData = {
    ...
    generateContentReadEvent: {
        ...
        isTrusted: false,
        timeStamp: 2255.0999999948544,
        type: 'renderer:telemetry:event',
        detail: {
            telemetryData: {
                actor: { id: '439a102168d501bc0babd548bc61299b026edf93c0c585fd8c3037bec7a073f8', type: 'User' },
                context: {
                    cdata: [{ id: 'cf5cea45c7db13a8add0874bf2dfdb94', type: 'ContentSession' }],

                    channel: '505c7c48ac6dc1edc9b08f21db5a571d',
                    env: 'contentplayer',
                    sid: 'dfef1a77-7f39-437d-b9b6-23a49098d741',
                    did: '439a102168d501bc0babd548bc61299b026edf93c0c585fd8c3037bec7a073f8',
                    pdata: {
                        id: 'prod.sunbird.desktop',
                        ver: '1.0', pid: 'sunbird-portal.contentplayer'
                    },
                    ...
                    ets: 1578906065851,
                    mid: 'START:2b0892a5b8100c4e8c10f24bcd689e07'
                },
                edata: { type: 'content', mode: 'play', pageid: '', duration: 1.92 },
                eid: 'START',
                ets: 1578906065851,
                mid: 'START:2b0892a5b8100c4e8c10f24bcd689e07',
                object: {
                    id: 'do_312352577520017408194',
                    type: 'Content', ver: '2', rollup: {
    ...
    generateContentImpressionEvent: {
        detail: {
            telemetryData: {
                eid: 'IMPRESSION',
            }
