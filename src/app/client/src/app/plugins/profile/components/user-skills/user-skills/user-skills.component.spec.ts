...
describe('UserSkillsComponent', () => {
  ...
  const data = {
    userProfile: {
      ...
      webPages: [{
        'type': 'fb',
        'url': 'https://www.facebook.com/harish'
      }],
      tcStatus: null,
      loginId: 'anujtech64',
      education: [
        {
          ...
          'yearOfPassing': '2015',
          'degree': 'BE',
          'updatedDate': '2017-12-18 12:18:30:996+0000',
          'userId': 'd5efd1ab-3cad-4034-8143-32c480f5cc9e',
          'addressId': null,
          'duration': null,
          'courseName': null,
          'createdDate': '2017-11-09 12:30:09:126+0000',
          'isDeleted': null,
          ...
          'percentage': '79',
          'name': 'SRMS',
          'id': '01237181711596748810'
        }],
      gender: 'Male',
      registeredOrg: null,
      regOrgId: null,
      subject: ['Assamese', 'Bengali', 'Biology', 'Chemistry', 'Economics', 'English', 'Environmental Studies', 'Geography', 'Gujarati'
      ],
      roles: ['CONTENT_REVIEWER'],
      language: ['English', 'Hindi', 'Marathi'],
      updatedDate: '2018 - 04 - 18 06: 06: 26: 730 + 0000',
      completeness: '94',
      isDeleted: null,
      organisations: [
      ],
      provider: null,
      countryCode: null,
      id: 'd5efd1ab - 3cad-4034 - 8143 - 32c480f5cc9e',
      tempPassword: null,
      email: 'an ********@gmail.com',
      jobProfile: [
        {
          ...
          updatedDate: '2018 - 02 - 13 04: 25: 08: 537 + 0000',
          isCurrentJob: false,
          verifiedBy: null,
          userId: 'd5efd1ab - 3cad-4034 - 8143 - 32c480f5cc9e',
          boardName: null,
          orgId: null,
          addressId: null,
          createdDate: '2018 - 02 - 11 18: 47: 20: 610 + 0000',
          isDeleted: null,
          createdBy: 'd5efd1ab - 3cad-4034 - 8143 - 32c480f5cc9e',
          verifiedDate: null,
          isRejected: null,
          id: '01243852734963712049'
        }
      ],
      address: [
        {
          ...
          zipcode: '667',
          addType: 'permanent',
          createdDate: '2018 - 04 - 17 18: 50: 55: 571 + 0000',
          isDeleted: null,
          createdBy: 'd5efd1ab - 3cad-4034 - 8143 - 32c480f5cc9e',
          addressLine1: 'p',
          addressLine2: 'p',
          id: '0124845376619479045',
          state: 'p'
        }
      ],
      rootOrg: {
      ...
      identifier: 'd5efd1ab - 3cad-4034 - 8143 - 32c480f5cc9e',
      profileVisibility: {
        identifier: 'd5efd1ab - 3cad-4034 - 8143 - 32c480f5cc9e',
        education: 'private',
        jobProfile: 'private',
      ...
      thumbnail: null,
      updatedBy: 'd5efd1ab - 3cad-4034 - 8143 - 32c480f5cc9e',
      profileSummary: `Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
      ...
      tcUpdatedDate: null,
      avatar: 'https://sunbirddev.blob.core.windows.net/user/userid/File-01243901151375360070.png',
      userName: 'anujtech64',
      rootOrgId: 'ORG_001',
      userId: 'd5efd1ab - 3cad-4034 - 8143 - 32c480f5cc9e',
      emailVerified: null,
      firstName: 'Anuj',
      lastLoginTime: '1524035119683',
      createdDate: '2017 - 10 - 03 04: 47: 22: 184 + 0000',
      createdBy: null,
      phone: '****** 6453',
      dob: null,
      grade: ['Kindergarten', 'Grade 2', 'Grade 3', 'Grade 4', 'Grade 5', 'Grade 6', 'Grade 8', 'Grade 9', 'Grade 10',
      ],
      currentLoginTime: null,
      location: 'vaish location',
      status: '1'
    }
  };
  beforeEach(async(() => {
  ...
  it('should call toggle method', () => {
    ...
    userService._userData$.next({ err: null, userProfile: data.userProfile });
    const lim = true;
    data.userProfile.skills.length = 1;
    component.userProfile = data.userProfile;
    component.limit = data.userProfile.skills.length;
    spyOn(component, 'toggle').and.callThrough();
    component.toggle(lim);
    expect(component.viewMore).toBe(false);
  });
  it('should pass else consition in toggle method', () => {
    const userService = TestBed.get(UserService);
    userService._userProfile = data.userProfile;
    userService._userData$.next({ err: null, userProfile: data.userProfile });
    const lim = false;
    data.userProfile.skills.length = 3;
    component.limit = data.userProfile.skills.length;
    spyOn(component, 'toggle').and.callThrough();
    component.toggle(lim);
