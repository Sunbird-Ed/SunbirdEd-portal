...
describe('GuestProfileComponent', () => {
	...
	it('should call getGuestUser method', () => {
        ...
        expect(mockCslFrameworkService.frameworkLabelTransform).toHaveBeenCalledWith(
	...
	describe('ngOninit',()=>{
       ...
       it('should call getFrameworkCategories of cslFramework',()=>{
		  const mockCategories ={ category1:'mock-category1',category2:'mock-category2'}
		  jest.spyOn(component['cslFrameworkService'],'getFrameworkCategories').mockReturnValue(of(mockCategories));
		  jest.spyOn(component.userService as any,'getGuestUser' as any).mockReturnValue(of({}));
		  jest.spyOn(component.layoutService,'switchableLayout').mockReturnValue(of({}));
	   ...
	   it('should call getFrameworkCategoriesObject of cslFramework',()=>{
		   const mockCategoriesObject ={object1: 'mockCategoryObject'};
		   jest.spyOn(component['cslFrameworkService'],'getFrameworkCategoriesObject').mockReturnValue(of(mockCategoriesObject));
           jest.spyOn(component.userService as any,'getGuestUser' as any).mockReturnValue(of({}));
		   jest.spyOn(component.layoutService,'switchableLayout').mockReturnValue(of({}));
           jest.spyOn(component.deviceRegisterService,'fetchDeviceProfile').mockReturnValue(of(mockDevice));
	       component.ngOnInit();
