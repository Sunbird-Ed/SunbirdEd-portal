...
imports: [ChartsModule, SuiModule, ReactiveFormsModule, SharedModule.forRoot(), HttpClientTestingModule, NgxDaterangepickerMd.forRoot()]
})
.compileComponents();
}));
...
let spy = spyOn(component, 'getDataSetValue').and.callThrough();
component.ngOnInit();
...
let spy = spyOn(component, 'buildFiltersForm').and.callThrough();
component.ngOnInit();
expect(spy).toHaveBeenCalled();
...
let spy = spyOn(component, 'resetFilter').and.callThrough();
let resetButton = fixture.debugElement.query(By.css('.sb-btn.sb-btn-outline-primary.sb-btn-normal'));
...
component.ngOnInit();
tick(1000);
component.getDateRange({ startDate: 'Tue Jan 08 2019 00:00:00 GMT+0530 (India Standard Time)', endDate: 'Tue Jan 10 2019 00:00:00 GMT+0530 (India Standard Time)' }, 'Grade');
tick(1000);
