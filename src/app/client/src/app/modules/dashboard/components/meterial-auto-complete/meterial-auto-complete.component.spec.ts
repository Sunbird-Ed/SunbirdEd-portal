...
import { MeterialAutoCompleteComponent } from './meterial-auto-complete.component';
import { NO_ERRORS_SCHEMA } from '@angular/core';
import { CoreModule } from '@sunbird/core';
import { configureTestSuite } from '@sunbird/test-util';
import { AutocompletePipe } from './AutocompletePipe'

describe('MeterialAutoCompleteComponent', () => {
  let component: MeterialAutoCompleteComponent;
