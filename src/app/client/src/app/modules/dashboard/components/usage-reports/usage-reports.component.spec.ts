...
//   });
//   xit('chartData defaults to: []', () => {
//     expect(component.chartData).toEqual([]);
//   });
//   xit('isTableDataLoaded defaults to: false', () => {
//     expect(component.isTableDataLoaded).toEqual(false);
//   });
//   xit('makes expected calls of ngOnInit and render the report ', () => {
...
//   });
//   xit('should call downloadCSV method ', () => {
//     const usageService = TestBed.get(UsageService);
