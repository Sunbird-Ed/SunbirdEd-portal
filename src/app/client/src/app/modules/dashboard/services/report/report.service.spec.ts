...
xdescribe('ReportService', () => {
  ...
  it('should be created', () => {
    const service: ReportService= <any> TestBed.inject(ReportService);
    expect(service).toBeTruthy();
  });

  it('should fetchDataSource', (done) => {
    usageService= <any> TestBed.inject(UsageService);
  ...
  it('should fetchReportById', (done) => {
    baseReportService= <any> TestBed.inject(BaseReportService);
...
xdescribe('isAuthenticated function', () => {
    ...
    it('return true if authenticated ', () => {
      permissionService= <any> TestBed.inject(PermissionService);
