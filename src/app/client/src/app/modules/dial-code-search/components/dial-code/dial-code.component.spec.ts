...
describe('DialCodeComponent', () => {
  ...
  beforeEach(() => {
    ...
    config= <any> TestBed.inject(ConfigService);
    ...
    dialCodeService= <any> TestBed.inject(DialCodeService);
    ...
    telemetryService= <any> TestBed.inject(TelemetryService);
 ...
 // xit('Dial code search API call should generate telemetry interact event', () => {
  ...
  it('should handle browser back click for navigation', () => {
    ...
    component.searchResults = [{data: 'sample'}];
    component.router = {url: '/get/dial/SAMPLE-DIAL-CODE'} as any;
