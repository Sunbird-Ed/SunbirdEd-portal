...
describe('ExplorePageComponent', () => {
  ...
  beforeEach(() => {
    ...
    pageApiService= <any> TestBed.inject(SearchService);
    orgDetailsService= <any> TestBed.inject(OrgDetailsService);
    cacheService= <any> TestBed.inject(CacheService);
    segmentationTagService= <any> TestBed.inject(SegmentationTagService);
 ...
 xit('should get channel id if slug is not available', done => {
    ...
    const contentSearchService= <any> TestBed.inject(ContentSearchService);
 ...
 xit('should call the getFilter Method and set audience type as filters', () => {
  ...
  describe('it should play content', () => {
    ...
    beforeEach(() => {
      publicPlayerService= <any> TestBed.inject(PublicPlayerService);
      courseService= <any> TestBed.inject(CoursesService);
      playerService= <any> TestBed.inject(PlayerService);
