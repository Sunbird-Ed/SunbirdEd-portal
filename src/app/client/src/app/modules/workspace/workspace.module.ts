...
import {
  ...
  BatchListComponent, BatchPageSectionComponent, BatchCardComponent, UpdateBatchComponent,
...
@NgModule({
  ...
  declarations: [WorkspaceComponent, WorkspacesidebarComponent,
    ...
    FlaggedComponent, BatchListComponent, BatchPageSectionComponent, BatchCardComponent, UpdateBatchComponent,
