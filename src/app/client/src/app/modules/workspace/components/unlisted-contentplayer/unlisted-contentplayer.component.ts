...
@Component({
  selector: 'app-unlisted-contentplayer',
  templateUrl: './unlisted-contentplayer.component.html',
  styleUrls: ['./unlisted-contentplayer.component.css']
})
export class UnlistedContentplayerComponent implements OnInit {
