...
export class TelemetryService {
  ...
  /**
   * To hold actual telemetry events generated by the telemetry library
   */
  public telemetryEvents: any = [];
  ...
  public initialize(context: ITelemetryContext) {
    ...
    ? (document.getElementsByTagName('html')) : undefined;
    const layout = el[0].attributes['layout'].value === 'joy' ? 'joy' : 'old'
