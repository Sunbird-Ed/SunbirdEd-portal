...
import {
  ...
  OfflineCardService, RecaptchaService} from './services';
...
@NgModule({
  ...
  declarations: [AppLoaderComponent, AnnouncementInboxCardComponent, DateFormatPipe, PageSectionComponent,
    ...
    OfflineApplicationDownloadComponent, HighlightTextDirective, FullPageModalComponent, AccountMergeModalComponent, SortByPipe, ConfirmPopupComponent],
