...
@NgModule({
  ...
  declarations: [AppLoaderComponent, DateFormatPipe,
    ...
    ConfirmPopupComponent, AddToGroupDirective, SbDatatableComponent, SelectOptionGroupComponent, AppLandingSectionComponent, MarkdownDirective, OnDemandReportsComponent, SbDataTablePipe],
