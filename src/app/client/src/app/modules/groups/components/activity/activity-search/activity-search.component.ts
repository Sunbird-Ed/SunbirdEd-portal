...
import { CsGroupAddableBloc } from '@jeraldj/client-services/blocs';
...
export class ActivitySearchComponent implements OnInit, OnDestroy {
  ...
  /**
   * @description - On language change dropdown this method will update the label and placeholder of the search filter
   */
