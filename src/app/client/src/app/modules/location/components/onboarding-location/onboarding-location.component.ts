...
import { DeviceRegisterService, UserService } from '../../../../modules/core/services';
...
export class OnboardingLocationComponent implements OnInit {
  ...
  processDistrictLocation(district, stateData) {
    ...
    return this.locationService.getUserLocation(requestData).pipe(map((res: any) => {
  ...
  getState() {
    ...
    this.locationService.getUserLocation(requestData).subscribe((res) => {
