...
export const CollectionHierarchyGetMockResponse = {
  ...
  copyCourseContentData : {
    ...
    eventDataWithContent: {
        ...
        {
            'parent': 'do_11303070829060917894',
            'code': '8981daac-6d18-4322-81b3-5da1c284119b',
            'mimeType': 'application/vnd.ekstep.content-collection',
            'visibility': 'Parent',
        },
        {
            'parent': 'do_113030708290624568',
            'code': '8981daac-6d18-4322-81b3-5da1c284119b',
            'mimeType': 'application/vnd.ekstep.content-collection',
            'visibility': 'Parent',
        }]
