...
@NgModule({
  ...
  declarations: [ContentImportHeaderComponent, WatchVideoComponent, NetworkStatusComponent,
    ...
    NetworkStatusComponent, WatchVideoComponent, DownloadManagerComponent, OfflineHelpCenterComponent, DesktopAppUpdateComponent
  ],
  entryComponents: [
  ...
  exports: [DesktopAppUpdateComponent]
})
