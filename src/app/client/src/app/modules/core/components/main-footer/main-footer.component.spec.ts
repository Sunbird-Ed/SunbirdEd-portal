...
describe('MainFooterComponent', () => {
    ...
    it('should redirect to diksha app with UTM params if dialcode avaiable', () => {
        ...
        expect(spy).toHaveBeenCalledWith('https://play.google.com/store/apps/details?id=in.gov.diksha.app&utm_source=diksha-sunbird&utm_medium\
=paytm&utm_campaign=dial&utm_term=EJ23P');
    });
