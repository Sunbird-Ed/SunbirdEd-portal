...
describe('PermissionService', () => {
  ...
  it('should fetch permission', () => {
    ...
    spyOn(learnerService, 'get').and.returnValue(Observable.of(mockPermissionRes.success));
  ...
  it('should throw toaster error message when permission api fails', () => {
    ...
    const learnerService = TestBed.get(LearnerService);
    spyOn(learnerService, 'get').and.returnValue(Observable.throw(mockPermissionRes.error));
