import { async, TestBed, inject, ComponentFixture, tick } from '@angular/core/testing';
...
describe('ProgramComponent On Bording test', () => {
  ...
  // it('should fetchFrameWorkDetails be called', inject([FrameworkService], (frameworkService) => {
  //   spyOn(component, 'fetchFrameWorkDetails');
  //   component.fetchFrameWorkDetails();
  //   expect(component.fetchFrameWorkDetails).toHaveBeenCalled();

  //   frameworkService.frameworkData$.and.returnValue({ subscribe: (frameworkDetails) => {
  //     console.log(frameworkDetails);

  //   } });


//     console.log(getFrameWorkServiceSpy);
