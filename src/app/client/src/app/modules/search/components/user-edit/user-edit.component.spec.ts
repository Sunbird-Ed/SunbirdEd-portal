...
describe('UserEditComponent', () => {
  ...
  it('should call getBlock', () => {
    ...
    spyOn(profileService, 'getUserLocation').and.returnValue(of(Response.getUserLocationResponse));
  ...
  it('should call getSchool', () => {
   ...
   component.initializeFormFields();
   spyOn(orgDetailsService, 'fetchOrgs').and.returnValue(of(Response.orgDetails));
...
it('should call updateProfile', () => {
  ...
  spyOn(profileService, 'updatePrivateProfile').and.returnValue(of(serverResponse));
...
it('should call updateProfile error case', () => {
  ...
  const profileService = TestBed.get(ProfileService);
  spyOn(toasterService, 'error').and.callFake(()=>{});
  spyOn(profileService, 'updatePrivateProfile').and.returnValue(observableThrowError('sorry'));
  component.userDetails= Response.userData;
  component.initializeFormFields();
  component.updateProfile();
