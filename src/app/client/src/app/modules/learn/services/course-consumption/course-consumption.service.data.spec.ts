export const courseConsumptionServiceMockData = {
  contents: [{
    'ownershipType': [
      'createdBy'
    ],
    ...
    'children': [
      {
        ...
        'appIcon': 'https://sunbirddev.blob.core.windows.net/sunbird-content-dev/content/do_11287204084174028818/artifact/06_maths_book_1566813333849.thumb.jpg',
        'assets': [
