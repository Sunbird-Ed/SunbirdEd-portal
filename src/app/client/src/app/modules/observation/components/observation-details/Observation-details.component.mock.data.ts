  ...
  result: [
    {
      ...
      evidencesStatus: [
        { name: "School Leadership and Management Team", code: "SL_1620912285090", status: "notstarted" },
        { name: "Teaching and Learning Practices", code: "TLP_1620912285090", status: "notstarted" }
      ],
      isRubricDriven: true,
