...
describe('ObservationListingComponent', () => {
    ...
    it('should call setTelemetryData', () => {
        const mockTelemetryData = {
            ...
            "edata": {
                "duration": 1, "pageid": "mock-page-id",
    ...
    describe('setFormat', () => {
        it('should set the contentList and update showLoader', () => {
            ...
            component.categoryKeys =
                [
                    ...
                    },
                    {
                        "index": 1,
                        "code": "board",
                        "alternativeCode": "board",
                        "label": "Framework"
                    },
                    {
                        "index": 2,
                        "code": "farmingtype",
                        "alternativeCode": "farmingtype",
                        "label": "farmingtype"
                    },
                    {
                        "index": 3,
                        "code": "cropcategory",
                        "alternativeCode": "cropcategory",
                        "label": "Crop Category"
                    },
                    {
                        "index": 4,
                        "code": "croptype",
                        "alternativeCode": "croptype",
                        "label": "croptype"
                    }
                ]
            ...
            expect(component.contentList[0]).toEqual({
                ...
                solutionId: '1',
                programId: '123',
                farmingtype: 'mock-language',
                organization: 'mock-name',
                _id: 'mock123',
                croptype: 'mock-program',
                cropcategory: ['mock-name'],
            });
        });
