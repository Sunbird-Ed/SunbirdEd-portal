...
describe('QuestionCreationComponent', () => {
  ...
  it('After component loaded should store config data', () => {
    component.ngOnChanges();
  });

  it('After component loaded should call initialize method', () => {
    component.ngOnInit();
  });

  it('After component loaded should generate impression telemetry event', () => {
    component.ngAfterViewInit();
  });

  it('After component loaded should init dropdown box', () => {
