import { selectedAttributes } from './../chapter-list/chapter-list.component.data';
export const Response = {
    ...
    selectedAttributes: {
        ...
        'lastOpenedUnit': 'do_11282684038818201618',
        'topicList': [
            {
        ...
        'textbookName': 'बाल रामकथा(HINDHI)',
        'hierarchyObj': {
            'hierarchy': {
        ...
        'topic': 'Topic 1',
        'questionType': 'mcq',
        'textBookUnitIdentifier': 'do_11282684038818201618',
