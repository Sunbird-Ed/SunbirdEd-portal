'use strict'
angular.module('playerApp').controller('createAnnouncementCtrl', ['$rootScope', '$scope', '$timeout', '$state', '$stateParams', 'config', 'toasterService', 'permissionsService', 'dashboardService', 'announcementService',
    ...
    function($rootScope, $scope, $timeout, $state, $stateParams, config, toasterService, permissionsService, dashboardService) {
        ...
        createAnn.previewAnn = function() {
            ...
            createAnn.previewData = {
                ...
                'type': createAnn.data.announcementType,
                'links': linkArray,
