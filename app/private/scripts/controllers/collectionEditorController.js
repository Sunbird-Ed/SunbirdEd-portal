  ...
  .controller('CollectionEditorController', ['config', '$stateParams', 'toasterService', '$sce',
    ...
    permissionsService) {
          ...
          collectionEditor.getTreeNodes = function (type) {
              ...
              switch (type) {
                case 'Course':
                    editorConfig.push({ type: 'Course', label: 'Course', isRoot: true, editable: true, childrenTypes: ['CourseUnit', 'Collection', 'Story', 'Worksheet'], addType: 'Editor', iconClass: 'fa fa-book' }, { type: 'CourseUnit', label: 'Course Unit', isRoot: false, editable: true, childrenTypes: ['CourseUnit', 'Collection', 'Story', 'Worksheet'], addType: 'Editor', iconClass: 'fa fa-folder-o' }, { type: 'Collection', label: 'Collection', isRoot: false, editable: false, childrenTypes: [], addType: 'Browser', iconClass: 'fa fa-file' }, { type: 'Story', label: 'Story', isRoot: false, editable: false, childrenTypes: [], addType: 'Browser', iconClass: 'fa fa-file-o' }, { type: 'Worksheet', label: 'Worksheet', isRoot: false, editable: false, childrenTypes: [], addType: 'Browser', iconClass: 'fa fa-file-o' });
                    return editorConfig;
                case 'Collection':
                    editorConfig.push({ type: 'Collection', label: 'Collection', isRoot: true, editable: true, childrenTypes: ['Collection', 'Story', 'Worksheet'], addType: 'Editor', iconClass: 'fa fa-folder-o' }, { type: 'Story', label: 'Story', isRoot: false, editable: false, childrenTypes: [], addType: 'Browser', iconClass: 'fa fa-file-o' }, { type: 'Worksheet', label: 'Worksheet', isRoot: false, editable: false, childrenTypes: [], addType: 'Browser', iconClass: 'fa fa-file-o' });
                    return editorConfig;
                case 'LessonPlan':
                    editorConfig.push({"type":"LessonPlan","label":"Lesson","isRoot":true,"editable":true,"childrenTypes":["LessonPlanUnit"],"addType":"Editor","iconClass":"fa fa-folder-o"},{"type":"LessonPlanUnit","label":"Lesson plan unit","isRoot":false,"editable":true,"childrenTypes":["Collection"],"addType":"Editor","iconClass":"fa fa-folder-o"},{"type":"Collection","label":"Collection","isRoot":false,"editable":true,"childrenTypes":[],"addType":"Browser","iconClass":"fa fa-file-o"});
                    return editorConfig;
                default:
