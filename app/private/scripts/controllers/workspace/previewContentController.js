...
angular.module('playerApp')
    .controller('PreviewContentController', function ($stateParams,
        playerTelemetryUtilsService, $rootScope, $state, $sce, contentService,
        pdfDelegate, $timeout, config, ToasterService) {
        ...
        function validateRequest(reqData, validateData) {
            ...
            var isMime =
                _.indexOf(validateData.mimeType, reqData.mimeType) > -1;
            if (isMime) {
         ...
         */
            window.addEventListener('renderer:telemetry:event',
            function (event) {
                org.sunbird.portal.eventManager
                .dispatchEvent('sunbird:player:telemetry',
            ...
            if (previewContent.contentData.mimeType ===
                'application/vnd.ekstep.ecml-archive'
                || previewContent.contentData.mimeType ===
                ...
                $timeout(function () {
                    ...
                    previewContentIframe.onload = function () {
                        ...
                        configuration.context.contentId =
                        previewContent.contentData.identifier;
                    // TODO: sid,uid,channel
                        ...
                        configuration.plugins =
                            config.ekstep_CP_config.config.plugins;
                        configuration.repos =
                            config.ekstep_CP_config.config.repos;
                        previewContentIframe
                            .contentWindow.initializePreview(configuration);
                    };
                }, 1000);
            } else {
        ...
        previewContent.closePreview = function () {
            ...
            window.removeEventListener('renderer:telemetry:event',
            function () {});
        ...
        previewContent.previous = function () {
            ...
            previewContent.getCurrentPage = previewContent.getCurrentPage > 1
                ? previewContent.getCurrentPage - 1
        ...
        previewContent.next = function () {
            ...
            if (previewContent.getCurrentPage ===
        ...
        previewContent.goToPage = function (pageNumber) {
            if (pageNumber > previewContent.getCurrentPage) {
                previewContent.contentProgress =
                previewContent.getCurrentPage
                 * 100 / previewContent.totalPageNumber;
            }
     ...
     */
        ...
        previewContent.publishContent = function () {
            ...
            previewContent[api] = {};
            previewContent[api].loader = ToasterService.loader('', $rootScope
            .errorMessages.WORKSPACE.PUBLISH_CONTENT.START);

            contentService.publish(request, previewContent.contentId)
            .then(function (res) {
                if (res && res.responseCode === 'OK') {
                    ...
                    ToasterService.success($rootScope
                        .errorMessages.WORKSPACE.PUBLISH_CONTENT.SUCCESS);
//                $state.go("WorkSpace.UpForReviewContent")
                } else {
                    previewContent[api].loader.showLoader = false;
                    ToasterService.error($rootScope
                        .errorMessages.WORKSPACE.PUBLISH_CONTENT.FAILED);
                }
            }).catch(function () {
                previewContent[api].loader.showLoader = false;
                ToasterService.error($rootScope
        ...
        previewContent.rejectContent = function () {
            var api = 'previewContentApi';
            previewContent[api] = {};
            previewContent[api].loader = showLoader('', $rootScope
                .errorMessages.WORKSPACE.REJECT_CONTENT.START);
            ...
            .then(function (res) {
                if (res && res.responseCode === 'OK') {
                    ...
                    previewContent.isShowPublishRejectButton = false;
                    ToasterService.success($rootScope
                        .errorMessages.WORKSPACE.REJECT_CONTENT.SUCCESS);
//                $state.go("WorkSpace.UpForReviewContent");
                } else {
                    previewContent[api].loader.showLoader = false;
                    ToasterService.error($rootScope
                        .errorMessages.WORKSPACE.REJECT_CONTENT.FAILED);
                }
            }).catch(function () {
                previewContent[api].loader.showLoader = false;
                ToasterService.error($rootScope
