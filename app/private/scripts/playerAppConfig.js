angular.module("playerApp.config", [])
    .constant("config", {
        ...
        "MESSAGES": {
            ...
            "NOTES": {
                ...
                "SEARCH": {
                    ...
                    "SUCCESS": "Note detail fetched successfully...",
                    "NO_RESULT": "You don't have any note, please create note..."
                },
                "UPDATE": {
            ...
            "PROFILE": {
                "HEADER": {
                    "START": "We are fetching profile...",
                    "FAILED": "Fetching profile failed, please try again later...",
                    "UPDATE": "Updating user profile failed,please try again later..."
                }
            },
            "SEARCH": {
                "COURSE": {
                    "START": "We are fetching profile...",
                    "FAILED": "Fetching courses failed, please try again later...",
                    "NO_RESULT": "No result found "
                },
                "RESOURCE": {
                    "START": "We are fetching profile...",
                    "FAILED": "Fetching resources failed, please try again later...",
                    "NO_RESULT": "No result found "
                }
            },
            "WORKSPACE": {
                "DRAFT": {
                    "START": "We are fetching draft content...",
                    "FAILED": "Fetching draft content failed, please try again later..."
                },
                "CREATE_SLIDESHOW": {
                    "START": "We are creating lesson...",
                    "FAILED": "Creating lesson failed, please try again later..."
                },
                "REVIEW": {
                    "START": "We are fetching review content...",
                    "FAILED": "Fetching review content failed, please try again later..."
                },
                "PUBLISHED": {
                    "START": "We are fetching published content...",
                    "FAILED": "Fetching published content failed, please try again later..."
                },
                "ALL_UPLOADED": {
                    "START": "We are fetching uploaded content...",
                    "FAILED": "Fetching uploaded content failed, please try again later..."
                }
            }
        },
        "ekstep_CE_config": {
        ...
        "DROPDOWN": {
            "COMMON": {
                "languages": ["Bengali", "English", "Gujarati", "Hindi", "Kannada", "Marathi", "Punjabi", "Tamil", "Telugu"],
                "lessonTypes": ["Story", "Worksheet", "Game", "Plugin", "Template"],
                "subjects": ["Maths", "English", "Hindi", "Assamese", "Bengali", "Gujarati", "Kannada", "Malayalam", "Marathi", "Nepali", "Oriya", "Punjabi", "Tamil", "Telugu", "Urdu"],
                "grades": ["Kindergarten", "Grade 1", "Grade 2", "Grade 3", "Grade 4", "Grade 5", "Grade 6", "Grade 7", "Grade 8", "Grade 9", "Grade 10", "Grade 11", "Grade 12", "Other"],
                "audiences": ["Learner", "Instructor"],
                "ageGroup": ["<5", "5-6", "6-7", "7-8", "9-10", ">10", "Other"],
                "medium": ["English", "Hindi", "Assamese", "Bengali", "Gujarati", "Kannada", "Malayalam", "Marathi", "Nepali", "Oriya", "Punjabi", "Tamil", "Telugu", "Urdu", "Other"],
                "boards": ["NCERT", "CBSE", "ICSE", "MSCERT"]
            }
        }
    });