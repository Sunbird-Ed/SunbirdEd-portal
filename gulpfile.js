...
var paths = {
  ...
  test: ['test/spec/**/*.js'],
  testRequire: [
    yeoman.app + '/thirdparty/bower_components/angular/angular.js',
    yeoman.app + '/thirdparty/bower_components/angular-mocks/angular-mocks.js',
    yeoman.app + '/thirdparty/bower_components/angular-resource/angular-resource.js',
    yeoman.app + '/thirdparty/bower_components/angular-cookies/angular-cookies.js',
    yeoman.app + '/thirdparty/bower_components/angular-sanitize/angular-sanitize.js',
    yeoman.app + '/thirdparty/bower_components/angular-route/angular-route.js',
    'test/mock/**/*.js',
    'test/spec/**/*.js'
  ],
  karma: 'karma.conf.js',
