...
var paths = {
    ...
    testRequire: [
        ...
        player.app
        + '/thirdparty/bower_components/jasmine-jquery/lib/jasmine-jquery.js',
        player.app + '/thirdparty/bower_components/angular/angular.js',
        player.app
        + '/thirdparty/bower_components/angular-mocks/angular-mocks.js',
        player.app
        + '/thirdparty/bower_components/angular-cookies/angular-cookies.js',
        player.app
        + '/thirdparty/bower_components/angular-route/angular-route.js',
        player.app
        + '/thirdparty/bower_components/angular-ui-router/release/angular-ui-router.min.js',// eslint-disable-line

        player.app + '/thirdparty/semantic/semantic.min.js',
        player.app + '/thirdparty/bower_components/video.js/dist/video.js',
        player.app
         + '/thirdparty/bower_components/videojs-youtube/dist/Youtube.js',
        player.app + '/thirdparty/bower_components/ngstorage/ngStorage.js',
        player.app
         + '/thirdparty/bower_components/moment/min/moment-with-locales.min.js',

        player.app
        + '/thirdparty/bower_components/angular-pagedown/angular-pagedown.min.js',// eslint-disable-line
        player.app
         + '/thirdparty/bower_components/pagedown/Markdown.Converter.js',
        player.app
         + '/thirdparty/bower_components/pagedown/Markdown.Sanitizer.js',
        ...
        player.app
         + '/thirdparty/bower_components/slick-carousel/slick/slick.js',
        player.app + '/thirdparty/bower_components/pdfjs-dist/build/pdf.js',
        player.app
         + '/thirdparty/bower_components/angular-pdf-viewer/dist/angular-pdf-viewer.min.js',// eslint-disable-line
        player.app
         + '/thirdparty/bower_components/angular-translate/angular-translate.js',// eslint-disable-line
        player.app
        + '/thirdparty/bower_components/angular-sanitize/angular-sanitize.js',

        player.app
        + '/thirdparty/bower_components/file-upload/fine-uploader/fine-uploader.js',// eslint-disable-line
        player.app
        + '/thirdparty/bower_components/semantic-tree-picker/semantic-ui-tree-picker.js',// eslint-disable-line
        player.app
        + '/thirdparty/bower_components/angular-ui-router/release/stateEvents.min.jss',// eslint-disable-line
        player.app
        + '/thirdparty/bower_components/izitoast/dist/js/iziToast.min.js'
